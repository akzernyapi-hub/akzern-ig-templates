...
def main():
    ...
    if tip == "carousel":
        lineup_cover([p["gercek_url"] for p in prods], f"{A}/kapak-hero.png")  # premium sıralı dizilim (kırık küme yerine)
        ...
        lineup_cover([p["gercek_url"] for p in prods], f"{A}/kapak-hero.png")
